...
function title() {
      console.clear()
	  console.log(chalk.bold.red(figlet.textSync('AzzBot-MD', {
		font: 'Standard',
	...
	console.log(chalk.yellow(`\n                        ${chalk.green('[ Powered By YahyaGanzz ]')}\n\n${chalk.yellow('AzzBot-MD')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.yellow('Follow Insta AzzBot')} : ${chalk.white('KAZUYAKUN')}\n${chalk.yellow('Message Me On WhatsApp')} : ${chalk.white('+6281511480762')}\n${chalk.yellow('Rest Api')} : ${chalk.white('https://christian-id-api.herokuapp.com/docs')}\n${chalk.yellow('Youtube')} : ${chalk.white('MBY•OFFICIAL')}\n`))
}
